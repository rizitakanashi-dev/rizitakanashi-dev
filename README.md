![header](https://capsule-render.vercel.app/api?type=venom&color=0:3DDC84,100:00A3FF&height=200&text=Faris%20Al%20Farizi&desc=Fullstack%20AI%20Engineer%20||%20Arch%20Larp&descAlignY=70&fontColor=FFFFFF&textBg=false&animation=twinkling&fontName=Poppins&fontAlignY=43)
...
I’m currently working on designing scalable RESTful APIs and optimizing database performance. I build software prioritizing clean code, microservices architecture, and server-side logic. 

*Fun fact: I don't care about the UI as long as the API returns a status code 200 OK!*
...
**Backend & Systems**
- Languages: Go, JavaScript (Node.js), Express.js
- Databases: MariaDB (SQL)

**Current Focus & Learning**
- Advanced Architecture: Microservices, System Design
...
<div align="center">
  ...
  <a href="https://instagram.com/rizi.belajar_coding" target="_blank">
  ...
  <a href="https://wa.me/6283877800002" target="_blank">
